package com.cowgame.memorygame_gameplay4;
...
public class playgamelayout extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.playgame4);
	...
	public void Shuffle() {
		...
		cards[18] = R.drawable.card19;
		cards[19] = R.drawable.card20;
		cards[20] = R.drawable.card21;
		cards[21] = R.drawable.card22;
		cards[22] = R.drawable.card23;
		cards[23] = R.drawable.card24;

		showcards = new int[48];
	...
	public void imgbtnon37(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton37);
		int cardnumber = showcards[36];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon38(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton38);
		int cardnumber = showcards[37];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon39(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton39);
		int cardnumber = showcards[38];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon40(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton40);
		int cardnumber = showcards[39];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon41(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton41);
		int cardnumber = showcards[40];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon42(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton42);
		int cardnumber = showcards[41];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon43(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton43);
		int cardnumber = showcards[42];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon44(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton44);
		int cardnumber = showcards[43];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon45(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton45);
		int cardnumber = showcards[44];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon46(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton46);
		int cardnumber = showcards[45];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon47(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton47);
		int cardnumber = showcards[46];

		cardbtn(btnme, cardnumber);
	}

	public void imgbtnon48(View v) {
		ImageButton btnme = (ImageButton) this.findViewById(R.id.imageButton48);
		int cardnumber = showcards[47];
